...
export interface IngvCesiumContext {
  ...
  ionAssetUrl?: string; // required when using layers from Cesium ION and offline plugin
  cesiumApiUrl?: string; // required when using layers from Cesium ION and offline plugin
  baseUrl?: string;
  catalogs: Record<
    string,
